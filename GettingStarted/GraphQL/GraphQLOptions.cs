namespace JCystems.GettingStarted.GraphQL
{
    using System.IO;
    using EntityGraphQL.Schema;
    using JCystems.GettingStarted.Connectors.Contexts;

    // SRC: https://github.com/EntityGraphQL/EntityGraphQL/blob/master/src/examples/AzureFunctionApp/GraphQLSchema.cs
    public class GraphQLOptions
    {
        public static void ConfigureSchema(SchemaProvider<DemoContext> demoSchema)
        {
            ...
            //    queryType.ReplaceField("writers", db => db.People.Where(p => p.WriterOf.Any()), "List of writers");
            ...
            File.WriteAllText("AppData/schema.graphql", demoSchema.ToGraphQLSchemaString());
        }
    }
}
